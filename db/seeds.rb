...
shinmio = Shop.create(name: "Shinmio", address: "900 Beacon St Unit D", city: "Boston", state: "MA", zip: "02215", telephone: "(617) 936-3440", website: "https://www.shinmiotea.com/", picture: "https://s3-media0.fl.yelpcdn.com/bphoto/1NKyIoU2zCp0SyyiuqrGPA/o.jpg")
...
alana = User.create(first_name: "Alana", last_name: "Lee", email: "alana@outlook.com", password: "Earlgraymilktea4life", role: "admin")
taylor = User.create(first_name: "Taylor", last_name: "Le", email: "taylor.l.kingston@gmail.com", password: "OoooLong5", role: "admin")
